                ...
                <div class="col-3">
                    <form action="/allatok" method="POST" class="form-control border border-dark">
                        ...
                        <div class="py-3">
                            ...
                            <label for="dog" class="form-check-label">Kutya</label>
                            <input type="checkbox" name="kperm" id="cat"  value="cat" class="form-check-input">
                            <label for="cat" class="form-check-label">Macska</label>
                        ...
                        <div class="py-3">
                            ...
                            <label for="cfriend">Gyermekbarát</label>
                            <input type="checkbox" name="traits" id="afriend"  value="afriend">
                            <label for="afriend">Más állatokkal barátságos</label>
                        ...
                        <div class="py-3">
                            ...
                            <label for="adoptable">Örökbefogadható</label>
