...
{{-- SWALFIREEK --}}
  ...
  <nav class="container-fluid nav-bg navbar navbar-expand-lg" aria-label="Thirteenth navbar example" id="stickyNav">
    <div class="container-fluid nav-bg navbar-dark d-flex justify-content-center">
      <a class="navbar-brand me-0" href="/"><img src="http://127.0.0.1:8000/img/layout/logo.png" alt="logo" class="logo"></a>
      <div class="d-flex flex-lg-row-reverse justify-content-between w-lg-100 w-75" style="flex-direction:column">
          <div class="d-lg-flex justify-content-end">
                    <button id="theme-switch">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M480-120q-150 0-255-105T120-480q0-150 105-255t255-105q14 0 27.5 1t26.5 3q-41 29-65.5 75.5T444-660q0 90 63 153t153 63q55 0 101-24.5t75-65.5q2 13 3 26.5t1 27.5q0 150-105 255T480-120Z"></path></svg>
                    </button>
                    @if(Auth::check())
                    <a class="nav-link" style="display: flex;align-items: center;margin-left: 20px;justify-content: center;" href="/mypage"><img src="{{asset('img/layout/auth.png')}}" alt="profile" class="logo">Fiókod</a>
                    @else
                    <a class="nav-link" style="display: flex;align-items: center;margin-left: 20px;justify-content: center;" href="/sign"><img src="{{asset('img/layout/auth.png')}}" alt="profile" class="logo">Jelentkezz be</a>
                    @endif
                </div>
          ...
          <div class="navbar-collapse d-lg-flex justify-content-start justify-content-column collapse" id="navbarsExample11" style="">
