...
{{-- SWALFIREEK --}}
  ...
  <!--NAV-bar-->
  <nav class="container-fluid nav-bg navbar navbar-expand-lg px-3" aria-label="Thirteenth navbar example" id="stickyNav">
    ...
    <div class="navbar-collapse collapse ps-3" id="navbarsExample11">
        ...
        <div class="d-flex justify-content-center ms-auto pe-3">
            @if(Auth::check())
            <a class="nav-link" style="display: flex;align-items: center;margin-left: 20px;justify-content: center; padding-right: 20px" href="/mypage"><img src="{{asset('img/layout/auth.png')}}" alt="profile" class="logo">Fiókod</a>
            @else
            <a class="nav-link" style="display: flex;align-items: center;margin-left: 20px;justify-content: center; padding-right: 20px" href="/sign"><img src="{{asset('img/layout/auth.png')}}" alt="profile" class="logo">Jelentkezz be</a>
            @endif
